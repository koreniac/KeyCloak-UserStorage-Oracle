...
public class DemoUserStorageProviderFactory implements UserStorageProviderFactory<DemoUserStorageProvider> {
    ...
    public static final String DB_SCHEMA_KEY = "db:schema";
    ...
    static {
        configMetadata = ProviderConfigurationBuilder.create()
                ...
                .defaultValue("bla bla bla")               //<---- set your default
                ...
                .type(ProviderConfigProperty.STRING_TYPE)
                .label("Database Host")
                .defaultValue("192.168.1.33")             //<---- set your default
                ...
                .type(ProviderConfigProperty.STRING_TYPE)
                .label("Database Name")
                .defaultValue("ABCDEFG")                //<---- set your default
                .helpText("Your Db need to connect")
                .add()
                ...
                .type(ProviderConfigProperty.STRING_TYPE)
                .label("Database Port")
                .defaultValue("1545")                   //<---- set your default
                .add()

                // DB Table
                .property().name(DB_SCHEMA_KEY)
                .type(ProviderConfigProperty.STRING_TYPE)
                .label("Database SCHEMA")
                .defaultValue("SCHEMA")                 //<---- set your default
                .add()
                .build();
    }
    ...
    public DemoUserStorageProvider create(KeycloakSession session, ComponentModel model) {
        ...
        if(entityManagerFactory == null) {
            ...
            properties.put("hibernate.default_schema", config.getFirst(DB_SCHEMA_KEY));
    ...
    public void validateConfiguration(KeycloakSession session, RealmModel realm, ComponentModel config) throws ComponentValidationException {
        ...
        if(StringUtils.isBlank(configMap.getFirst(DB_SCHEMA_KEY))) {
            throw new ComponentValidationException("Database password empty.");
        }
    }
...
//                return Thread.currentThread().getContextClassLoader();
    ...
    @Override
    public String getId() {
        return "MVP-SRP(oracle)-USER-PROVIDER-65";
    }
}